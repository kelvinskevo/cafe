                                ...
                                <tr>
                                    <td class="py-1">
                                        <img src="{{ asset('admin/user_images/' . $food->image) }}" alt="{{ $food->title }}" ">
                                                                               ...
                                                                               <td>
        <form id="delete-form-{{ $food->id }}" action="{{ route('foods.destroy', $food->id) }}" method="post">
            @csrf
            @method('DELETE')
            ...
            <button type="button" class="btn btn-inverse-danger" onclick="confirmDelete({{ $food->id }})">
