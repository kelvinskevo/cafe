                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="preview-list">
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('admin/assets/images/faces/face6.jpg') }}"
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('admin/assets/images/faces/face8.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="flex-grow preview-item-content d-flex">
                                                <div class="flex-grow">
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('admin/assets/images/faces/face9.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="flex-grow preview-item-content d-flex">
                                                <div class="flex-grow">
                                        ...
                                        <div class="preview-item border-bottom">
                                            <div class="preview-thumbnail">
                                                <img src="{{ asset('admin/assets/images/faces/face11.jpg') }}"
                                                    alt="image" class="rounded-circle" />
                                            </div>
                                            <div class="flex-grow preview-item-content d-flex">
                                                <div class="flex-grow">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel"
                                        ...
                                        <div class="item">
                                            <img src="{{ asset('admin/assets/images/dashboard/Rectangle.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="item">
                                            <img src="{{ asset('admin/assets/images/dashboard/Img_5.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="item">
                                            <img src="{{ asset('admin/assets/images/dashboard/img_6.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="py-4 d-flex">
                                        <div class="preview-list w-100">
                                            <div class="p-0 preview-item">
                                                <div class="preview-thumbnail">
                                                    <img src="{{ asset('admin/assets/images/faces/face12.jpg') }}"
